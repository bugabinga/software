...
version against the latest release, and outbound links that have died since last
week. Everything else in the sweep is a check that some other trigger usually
catches first.
