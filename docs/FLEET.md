...
| Page            | What it is                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<site>/skill/` | Builds the note-taker's skill. Two fields in, a zip out, assembled in the browser so the intake token never leaves the page -- there is no server behind a static file on Pages, which is the whole reason this is a page rather than an endpoint. `?inbox=` prefills the address, and `worker-deploy.yml` links here with it filled in. The deploy also attaches the same zip to its own run, built by `tools/make_skill.py` from this page's script; see `docs/NOTES-INBOX.md`. |
